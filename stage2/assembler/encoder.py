...
def encode_load_constant(instr: Instruction) -> bytearray:
    ...
    if not (0 <= instr.field_c <= 0xFFFFFFF):  # 28 бит
    ...
    c_value = instr.field_c

    data[2] = (c_value >> 20) & 0xFF  # Старшие 8 бит из 28
    data[3] = (c_value >> 12) & 0xFF  # Следующие 8 бит
    data[4] = (c_value >> 4) & 0xFF   # Следующие 8 бит
